...
public class SimulatedMeasureServiceTest {
     ...
     */
    private SimulatedCaptor captor = new SimulatedCaptor("test", new Site("Site A"), 500000, 1000000);
    /**
...
// And we have a value for each hour of the period
        assertThat(measures)
                ...
                .containsExactly(tuple(Instant.parse("2018-09-01T22:00:00Z"),1234), tuple(Instant.parse("2018-09-01T22:30:00Z"),4567)
                );
    }
}
